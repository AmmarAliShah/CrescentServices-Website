...
var Util = function($) {
    ...
    function o() {
        r = n(),
        $.fn.emulateTransitionEnd = s,
        l.supportsTransitionEnd() && ($.event.special[l.TRANSITION_END] = i())
    }
    var r = !1
      , a = {
            ...
            for (var o in s)
                if (s.hasOwnProperty(o)) {
                    var r = s[o]
                      , a = n[o]
                      , l = void 0;
                    if (l = a && e(a) ? "element" : t(a),
                    !new RegExp(r).test(l))
                        throw new Error(i.toUpperCase() + ": " + ('Option "' + o + '" provided type "' + l + '" ') + ('but expected type "' + r + '".'))
                }
        }
    };
    return o(),
  ...
  , Carousel = function($) {
    var t = "carousel"
      ...
      , d = function() {
        ...
        return _createClass(s, [{
            ...
            value: function f(t) {
                t || (this._isPaused = !0),
                $(this._element).find(p.NEXT_PREV)[0] && Util.supportsTransitionEnd() && (Util.triggerTransitionEnd(this._element),
                this.cycle(!0)),
            ...
            key: "_getItemIndex",
            value: function w(t) {
                return this._items = $.makeArray($(t).parent().find(p.ITEM)),
            ...
            value: function _(t, e) {
                ...
                return $(this._element).trigger(i),
                i
            }
        }, {
            ...
            value: function k(t, e) {
                ...
                if (!l.isDefaultPrevented() && n && s) {
                    ...
                    Util.supportsTransitionEnd() && $(this._element).hasClass(u.SLIDE) ? ($(s).addClass(t),
                    Util.reflow(s),
                    $(n).addClass(a),
                    $(s).addClass(a),
                    $(n).one(Util.TRANSITION_END, function() {
                    ...
                    }).emulateTransitionEnd(r)) : ($(n).removeClass(u.ACTIVE),
                    $(s).addClass(u.ACTIVE),
                    this._isSliding = !1,
    ...
    return $(document).on(c.CLICK_DATA_API, p.DATA_SLIDE, d._dataApiClickHandler),
        ...
        return _createClass(n, [{
            ...
            value: function o() {
                ...
                if (!this._isTransitioning && !$(this._element).hasClass(c.IN)) {
                    var e = void 0
                      , s = void 0;
                    if (this._parent && (e = $.makeArray($(p.ACTIVES)),
                    e.length || (e = null)),
                    !(e && (s = $(e).data(i),
                    s && s._isTransitioning))) {
                        var o = $.Event(h.SHOW);
                        if ($(this._element).trigger(o),
                        !o.isDefaultPrevented()) {
                            e && (n._jQueryInterface.call($(e), "hide"),
                            s || $(e).data(i, null));
                            ...
                            var l = function v() {
                                $(t._element).removeClass(c.COLLAPSING).addClass(c.COLLAPSE).addClass(c.IN),
                                t._element.style[a] = "",
                                t.setTransitioning(!1),
                                $(t._element).trigger(h.SHOWN)
                            };
                            if (!Util.supportsTransitionEnd())
                                return void l();
                            var u = a[0].toUpperCase() + a.slice(1)
                              , d = "scroll" + u;
                            $(this._element).one(Util.TRANSITION_END, l).emulateTransitionEnd(r),
            ...
            value: function d() {
                ...
                if (!this._isTransitioning && $(this._element).hasClass(c.IN)) {
                    ...
                    !e.isDefaultPrevented()) {
                        ...
                        var s = function o() {
                            t.setTransitioning(!1),
                            $(t._element).removeClass(c.COLLAPSING).addClass(c.COLLAPSE).trigger(h.HIDDEN)
                        };
                        return this._element.style[i] = 0,
                        Util.supportsTransitionEnd() ? void $(this._element).one(Util.TRANSITION_END, s).emulateTransitionEnd(r) : void s()
                    }
                }
            }
        }, {
            ...
            value: function j(t, e) {
                if (t) {
                    ...
                    e.length && $(e).toggleClass(c.COLLAPSED, !i).attr("aria-expanded", i)
                }
            }
        }], [{
            ...
            value: function C(t) {
                return this.each(function() {
                    ...
                    if (!s && o.toggle && /show|hide/.test(t) && (o.toggle = !1),
                    s || (s = new n(this,o),
                    e.data(i, s)),
                    "string" == typeof t) {
                        if (void 0 === s[t])
    ...
    var t = "dropdown"
      ...
      , h = function() {
        ...
        return _createClass(t, [{
            key: "toggle",
            value: function s() {
                if (this.disabled || $(this).hasClass(a.DISABLED))
                    return !1;
                ...
                if ("ontouchstart"in document.documentElement && !$(e).closest(l.NAVBAR_NAV).length) {
                    ...
                    n.className = a.BACKDROP,
                    $(n).insertBefore(this),
                    $(n).on("click", t._clearMenus)
                }
                var s = {
                    relatedTarget: this
                }
                ...
                $(e).toggleClass(a.OPEN),
                $(e).trigger($.Event(r.SHOWN, s)),
                !1)
            }
        }, {
            key: "dispose",
                ...
                if (!e || 3 !== e.which) {
                    ...
                    for (var n = $.makeArray($(l.DATA_TOGGLE)), s = 0; s < n.length; s++) {
                        ...
                        if ($(o).hasClass(a.OPEN) && !(e && "click" === e.type && /input|textarea/i.test(e.target.tagName) && $.contains(o, e.target))) {
                            ...
                            $(o).trigger(c),
                            c.isDefaultPrevented() || (n[s].setAttribute("aria-expanded", "false"),
                            $(o).removeClass(a.OPEN).trigger($.Event(r.HIDDEN, h)))
                        }
                    }
                }
            }
            ...
            value: function d(e) {
                ...
                e.stopPropagation(),
                !this.disabled && !$(this).hasClass(a.DISABLED))) {
        ...
        return _createClass(s, [{
            ...
            value: function C() {
                ...
                this._showBackdrop(function() {
                    $(document.body).removeClass(u.OPEN),
                    t._resetAdjustments(),
                    t._resetScrollbar(),
                    $(t._element).trigger(c.HIDDEN)
                })
            }
        }, {
            key: "_removeBackdrop",
            ...
            value: function x() {
                ...
                this._isBodyOverflowing = document.body.clientWidth < t,
    ...
    e.prototype.refresh = function() {
        ...
        for (var o in n) {
            ...
            for (var a in this.waypoints[o]) {
                var l = this.waypoints[o][a], h = l.options.offset, c = l.triggerPoint, u = 0, p = null == c, d, v, f, g, y;
                l.element !== l.element.window && (u = l.adapter.offset()[r.offsetProp]),
                "function" == typeof h ? h = h.apply(l) : "string" == typeof h && (h = parseFloat(h),
                l.options.offset.indexOf("%") > -1 && (h = Math.ceil(r.contextDimension * h / 100))),
                ...
                g = v && f,
                y = !v && !f,
                !p && g ? (l.queueTrigger(r.backward),
                i[l.group.id] = l.group) : !p && y ? (l.queueTrigger(r.forward),
                i[l.group.id] = l.group) : p && r.oldScroll >= l.triggerPoint && (l.queueTrigger(r.forward),
...
function(t) {
    ...
    function e(t, e) {
        ...
        if (i.value === s.attr("placeholder") && s.hasClass(u.customClass))
            if (i.value = "",
            s.removeClass(u.customClass),
            s.data("placeholder-password")) {
    ...
    function i(i) {
        var n, s = this, o = $(s), r = s.id;
        if (i && "blur" === i.type) {
            if (o.hasClass(u.customClass))
                return;
            if ("password" === s.type && (n = o.prevAll('input[type="text"]:first'),
            n.length > 0 && n.is(":visible")))
                return
        }
        if ("" === s.value) {
            if ("password" === s.type) {
            ...
            o.addClass(u.customClass),
            o[0].value = o.attr("placeholder")
        } else
            o.removeClass(u.customClass)
    }
    function n() {
        try {
    ...
    var s = "[object OperaMini]" === Object.prototype.toString.call(window.operamini), o = "placeholder"in document.createElement("input") && !s, r = "placeholder"in document.createElement("textarea") && !s, a = $.valHooks, l = $.propHooks, h, c, u = {};
    o && r ? (c = $.fn.placeholder = function() {
        return this
    }
    ,
    c.input = !0,
    c.textarea = !0) : (c = $.fn.placeholder = function(t) {
        var n = {
            customClass: "placeholder"
        };
        return u = $.extend({}, n, t),
        this.filter((o ? "textarea" : ":input") + "[placeholder]").not("." + u.customClass).bind({
            "focus.placeholder": e,
            "blur.placeholder": i
    ...
    h = {
        ...
        set: function(t, s) {
            var o = $(t), r, a;
            return "" !== s && (r = o.data("placeholder-textinput"),
            a = o.data("placeholder-password"),
            r ? (e.call(r[0], !0, s) || (t.value = s),
            r[0].value = s) : a && (e.call(t, !0, s) || (a[0].value = s),
            t.value = s)),
            o.data("placeholder-enabled") ? ("" === s ? (t.value = s,
            t != n() && i.call(t)) : (o.hasClass(u.customClass) && e.call(t),
            t.value = s),
            o) : (t.value = s,
            o)
        }
...
var vjs = function(t, e, i) {
    ...
    if ("string" == typeof t) {
        ...
        vjs.players[t])
            return e && vjs.log.warn('Player "' + t + '" is already initialised. Options will not be applied.'),
            i && vjs.players[t].ready(i),
            vjs.players[t];
        n = vjs.el(t)
    } else
        n = t;
...
vjs.addLanguage = function(t, e) {
    return void 0 !== vjs.options.languages[t] ? vjs.options.languages[t] = vjs.util.mergeOptions(vjs.options.languages[t], e) : vjs.options.languages[t] = e,
...
vjs.CoreObject.extend = function(t) {
    ...
    for (var n in t)
        t.hasOwnProperty(n) && (i.prototype[n] = t[n]);
    return i
}
,
...
vjs.on = function(t, e, i) {
    if (vjs.obj.isArray(e))
        return _handleMultipleEvents(vjs.on, t, e, i);
    var n = vjs.getData(t);
    ...
    n.dispatcher = function(e) {
        if (!n.disabled) {
            ...
            if (i)
                for (var s = i.slice(0), o = 0, r = s.length; r > o && !e.isImmediatePropagationStopped(); o++)
                    s[o].call(t, e)
        }
    }
    ),
...
vjs.off = function(t, e, i) {
    if (vjs.hasData(t)) {
        ...
        if (n.handlers) {
            if (vjs.obj.isArray(e))
                return _handleMultipleEvents(vjs.off, t, e, i);
            var s = function(e) {
                n.handlers[e] = [],
...
vjs.cleanUpEvents = function(t, e) {
    ...
    vjs.isEmpty(i.handlers) && (delete i.handlers,
    delete i.dispatcher,
    delete i.disabled),
...
vjs.fixEvent = function(t) {
    ...
    if (!t || !t.isPropagationStopped) {
        ...
        t = {};
        for (var s in n)
            "layerX" !== s && "layerY" !== s && "keyLocation" !== s && ("returnValue" == s && n.preventDefault || (t[s] = n[s]));
...
vjs.trigger = function(t, e) {
    ...
    e = vjs.fixEvent(e),
    i.dispatcher && i.dispatcher.call(t, e),
    n && !e.isPropagationStopped() && e.bubbles !== !1)
        vjs.trigger(n, e);
    else if (!n && !e.defaultPrevented) {
        var s = vjs.getData(e.target);
        e.target[e.type] && (s.disabled = !0,
...
vjs.one = function(t, e, i) {
    if (vjs.obj.isArray(e))
        return _handleMultipleEvents(vjs.one, t, e, i);
    var n = function() {
        vjs.off(t, e, n),
        i.apply(this, arguments)
    };
    n.guid = i.guid = i.guid || vjs.guid++,
    vjs.on(t, e, n)
}
;
...
,
vjs.obj = {},
vjs.obj.create = Object.create || function(t) {
    function e() {}
...
vjs.obj.each = function(t, e, i) {
    for (var n in t)
        hasOwnProp.call(t, n) && e.call(i || this, n, t[n])
}
,
...
vjs.obj.deepMerge = function(t, e) {
    ...
    t = vjs.obj.copy(t);
    for (i in e)
        hasOwnProp.call(e, i) && (n = t[i],
        s = e[i],
        vjs.obj.isPlain(n) && vjs.obj.isPlain(s) ? t[i] = vjs.obj.deepMerge(n, s) : t[i] = e[i]);
    return t
}
,
...
vjs.getData = function(t) {
    var e = t[vjs.expando];
    return e || (e = t[vjs.expando] = vjs.guid++),
...
vjs.ANDROID_VERSION = function() {
    var t = vjs.USER_AGENT.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i), e, i;
    return t ? (e = t[1] && parseFloat(t[1]),
    i = t[2] && parseFloat(t[2]),
    e && i ? parseFloat(t[1] + "." + t[2]) : e ? e : null) : null
}(),
...
vjs.getElementAttributes = function(t) {
    ...
    t && t.attributes && t.attributes.length > 0) {
        ...
        for (var r = n.length - 1; r >= 0; r--)
            s = n[r].name,
            o = n[r].value,
            ("boolean" == typeof t[s] || -1 !== i.indexOf("," + s + ",")) && (o = null !== o ? !0 : !1),
            e[s] = o
    }
    return e
}
...
vjs.parseUrl = function(t) {
    ...
    n && (e = vjs.createEl("div"),
    e.innerHTML = '<a href="' + t + '"></a>',
    i = e.firstChild,
...
vjs.xhr = function(t, e) {
    ...
    h = function() {
        ...
        e(null, n, n.response || n.responseText)
    }
    ,
    c = function(t) {
        window.clearTimeout(l),
    ...
    !a || !window.XDomainRequest || "withCredentials"in n ? (r = "file:" == s.protocol || "file:" == o.protocol,
    ...
    t.timeout && (l = window.setTimeout(function() {
        4 !== n.readyState && (n.timedout = !0,
        n.abort())
    }, t.timeout))) : (n = new window.XDomainRequest,
    n.onload = h,
    n.onerror = c,
...
vjs.util.mergeOptions = function(t, e) {
    ...
    t = vjs.obj.copy(t);
    for (i in e)
        e.hasOwnProperty(i) && (n = t[i],
        s = e[i],
        vjs.obj.isPlain(n) && vjs.obj.isPlain(s) ? t[i] = vjs.util.mergeOptions(n, s) : t[i] = e[i]);
    return t
}
,
...
vjs.Component.prototype.addChild = function(t, e) {
    ...
    e = e || {},
    n = e.componentClass || vjs.capitalize(s),
    e.name = s,
    i = new window.videojs[n](this.player_ || this,e)) : i = t,
...
vjs.Component.prototype.on = function(t, e, i) {
    var n, s, o, r, a, l;
    return "string" == typeof t || vjs.obj.isArray(t) ? vjs.on(this.el_, t, vjs.bind(this, e)) : (n = t,
    s = e,
    o = vjs.bind(this, i),
    l = this,
    r = function() {
    ...
    ,
    a.guid = o.guid,
    t.nodeName ? (vjs.on(n, s, o),
    vjs.on(n, "dispose", a)) : "function" == typeof t.on && (n.on(s, o),
    n.on("dispose", a))),
    this
}
,
vjs.Component.prototype.off = function(t, e, i) {
    var n, s, o, r, a;
    return !t || "string" == typeof t || vjs.obj.isArray(t) ? vjs.off(this.el_, t, e) : (n = t,
    o = e,
    r = vjs.bind(this, i),
    this.off("dispose", r),
    t.nodeName ? (vjs.off(n, o, r),
    vjs.off(n, "dispose", r)) : (n.off(o, r),
    n.off("dispose", r))),
    this
}
,
vjs.Component.prototype.one = function(t, e, i) {
    var n, s, o, r, a;
    return "string" == typeof t || vjs.obj.isArray(t) ? vjs.one(this.el_, t, vjs.bind(this, e)) : (n = t,
    s = e,
    o = vjs.bind(this, i),
    r = this,
    a = function() {
...
vjs.Component.prototype.addClass = function(t) {
    return vjs.addClass(this.el_, t),
    this
}
,
vjs.Component.prototype.removeClass = function(t) {
    return vjs.removeClass(this.el_, t),
    this
}
,
...
vjs.Component.prototype.emitTapEvents = function() {
    ...
    this.on("touchstart", function(i) {
        1 === i.touches.length && (e = vjs.obj.copy(i.touches[0]),
        t = (new Date).getTime(),
        n = !0)
    }),
    this.on("touchmove", function(t) {
        t.touches.length > 1 ? n = !1 : e && (o = t.touches[0].pageX - e.pageX,
    ...
    this.on("touchend", function(s) {
        e = null,
        n === !0 && (i = (new Date).getTime() - t,
        h > i && (s.preventDefault(),
        this.trigger("tap")))
    })
}
,
vjs.Component.prototype.enableTouchActivity = function() {
    var t, e, i;
    this.player().reportUserActivity && (t = vjs.bind(this.player(), this.player().reportUserActivity),
...
vjs.Button.prototype.createEl = function(t, e) {
    ...
    e.innerHTML || (this.contentEl_ = vjs.createEl("div", {
...
vjs.Slider.prototype.update = function() {
    if (this.el_) {
        var t, e = this.getPercent(), i = this.handle, n = this.bar;
        if (("number" != typeof e || e !== e || 0 > e || e === 1 / 0) && (e = 0),
        t = e,
        i) {
            var s = this.el_
              , o = s.offsetWidth
              ...
              , h = e * l;
            t = h + a / 2,
            i.el().style.left = vjs.round(100 * h, 2) + "%"
        }
...
vjs.Slider.prototype.calculateDistance = function(t) {
    var e, i, n, s, o, r, a, l, h;
    if (e = this.el_,
    i = vjs.findPosition(e),
    o = r = e.offsetWidth,
    a = this.handle,
    this.options().vertical) {
        if (s = i.top,
        h = t.changedTouches ? t.changedTouches[0].pageY : t.pageY,
        a) {
...
vjs.SliderHandle.prototype.createEl = function(t, e) {
    return e = e || {},
    e.className = e.className + " vjs-slider-handle",
    e = vjs.obj.merge({
...
vjs.Menu.prototype.addItem = function(t) {
    this.addChild(t),
    t.on("click", vjs.bind(this, function() {
        this.unlockShowing()
    }))
}
,
...
vjs.MenuButton.prototype.onKeyPress = function(t) {
    32 == t.which || 13 == t.which ? (this.buttonPressed_ ? this.unpressButton() : this.pressButton(),
    t.preventDefault()) : 27 == t.which && (this.buttonPressed_ && this.unpressButton(),
    t.preventDefault())
}
,
...
vjs.MediaError = function(t) {
    "number" == typeof t ? this.code = t : "string" == typeof t ? this.message = t : "object" == typeof t && vjs.obj.merge(this, t),
...
if (function() {
    ...
    if (i)
        for (vjs.browser.fullscreenAPI = {},
        n = 0; n < i.length; n++)
            vjs.browser.fullscreenAPI[e[n]] = i[n]
}(),
vjs.Player = vjs.Component.extend({
    init: function(t, e, i) {
        ...
        e.plugins && vjs.obj.each(e.plugins, function(t, e) {
            this[t](e)
        }, this),
...
vjs.Player.prototype.language = function(t) {
    return void 0 === t ? this.language_ : (this.language_ = t,
    this)
}
,
...
vjs.Player.prototype.getTagSettings = function(t) {
    ...
    if (e = vjs.getElementAttributes(t),
    i = e["data-setup"],
    null !== i && vjs.obj.merge(e, vjs.JSON.parse(i || "{}")),
    vjs.obj.merge(n, e),
    t.hasChildNodes()) {
        var s, o, r, a, l;
        for (s = t.childNodes,
        ...
        l = s.length; l > a; a++)
            ...
            "source" === r ? n.sources.push(vjs.getElementAttributes(o)) : "track" === r && n.tracks.push(vjs.getElementAttributes(o))
    }
    return n
}
,
vjs.Player.prototype.createEl = function() {
    var t = this.el_ = vjs.Component.prototype.createEl.call(this, "div"), e = this.tag, i;
    return e.removeAttribute("width"),
...
vjs.Player.prototype.loadTech = function(t, e) {
    ...
    "Html5" !== t && this.tag && (vjs.Html5.disposeMediaElement(this.tag),
    this.tag = null),
    this.techName = t,
    this.isReady_ = !1;
    var i = function() {
    ...
    this.tech = new window.videojs[t](this,n),
    this.tech.ready(i)
}
,
...
vjs.Player.prototype.techGet = function(t) {
    if (this.tech && this.tech.isReady_)
        try {
            ...
            this.tech.isReady_ = !1) : vjs.log(e),
            e
        }
}
,
...
vjs.Player.prototype.currentTime = function(t) {
    return void 0 !== t ? (this.techCall("setCurrentTime", t),
    this) : this.cache_.currentTime = this.techGet("currentTime") || 0
}
,
vjs.Player.prototype.duration = function(t) {
    return void 0 !== t ? (this.cache_.duration = parseFloat(t),
    this) : (void 0 === this.cache_.duration && this.onDurationChange(),
...
vjs.Player.prototype.buffered = function() {
    ...
    return t && t.length || (t = vjs.createTimeRange(0, 0)),
    t
}
,
vjs.Player.prototype.bufferedPercent = function() {
    var t = this.duration(), e = this.buffered(), i = 0, n, s;
    if (!t)
        return 0;
...
vjs.Player.prototype.volume = function(t) {
    ...
    this) : (e = parseFloat(this.techGet("volume")),
    isNaN(e) ? 1 : e)
}
,
vjs.Player.prototype.muted = function(t) {
    return void 0 !== t ? (this.techCall("setMuted", t),
    this) : this.techGet("muted") || !1
}
,
...
vjs.Player.prototype.requestFullscreen = function() {
    ...
    t ? (vjs.on(document, t.fullscreenchange, vjs.bind(this, function(e) {
        this.isFullscreen(document[t.fullscreenElement]),
        this.isFullscreen() === !1 && vjs.off(document, t.fullscreenchange, arguments.callee),
        this.trigger("fullscreenchange")
    })),
    this.el_[t.requestFullscreen]()) : this.tech.supportsFullScreen() ? this.techCall("enterFullScreen") : (this.enterFullWindow(),
    this.trigger("fullscreenchange")),
    this
}
,
...
vjs.Player.prototype.exitFullscreen = function() {
    ...
    t ? document[t.exitFullscreen]() : this.tech.supportsFullScreen() ? this.techCall("exitFullScreen") : (this.exitFullWindow(),
    this.trigger("fullscreenchange")),
    this
}
,
...
vjs.Player.prototype.selectSource = function(t) {
    for (var e = 0, i = this.options_.techOrder; e < i.length; e++) {
        ...
        if (s) {
            ...
            vjs.log.error('The "' + n + '" tech is undefined. Skipped browser support check for that tech.')
    }
    return !1
}
,
vjs.Player.prototype.src = function(t) {
    return void 0 === t ? this.techGet("src") : (vjs.obj.isArray(t) ? this.sourceList_(t) : "string" == typeof t ? this.src({
        src: t
    }) : t instanceof Object && (t.type && !window.videojs[this.techName].canPlaySource(t) ? this.sourceList_([t]) : (this.cache_.src = t.src,
...
vjs.Player.prototype.preload = function(t) {
    return void 0 !== t ? (this.techCall("setPreload", t),
    this.options_.preload = t,
    this) : this.techGet("preload")
}
,
vjs.Player.prototype.autoplay = function(t) {
    return void 0 !== t ? (this.techCall("setAutoplay", t),
    this.options_.autoplay = t,
    this) : this.techGet("autoplay", t)
}
,
vjs.Player.prototype.loop = function(t) {
    return void 0 !== t ? (this.techCall("setLoop", t),
    this.options_.loop = t,
    this) : this.techGet("loop")
}
,
...
vjs.Player.prototype.controls = function(t) {
    ...
    this.trigger("controlsenabled")) : (this.removeClass("vjs-controls-enabled"),
...
vjs.Player.prototype.error = function(t) {
    ...
    this) : (t instanceof vjs.MediaError ? this.error_ = t : this.error_ = new vjs.MediaError(t),
    this.trigger("error"),
...
vjs.Player.prototype.userActive = function(t) {
    ...
    this.tech && this.tech.one("mousemove", function(t) {
        t.stopPropagation(),
        t.preventDefault()
    }),
...
vjs.Player.prototype.listenForUserActivity = function() {
    ...
    e = function(e) {
        (e.screenX != a || e.screenY != l) && (a = e.screenX,
        l = e.screenY,
        t())
    }
    ,
...
vjs.Player.prototype.playbackRate = function(t) {
    return void 0 !== t ? (this.techCall("setPlaybackRate", t),
    this) : this.tech && this.tech.featuresPlaybackRate ? this.techGet("playbackRate") : 1
}
,
...
vjs.FullscreenToggle.prototype.onClick = function() {
    ...
    this.controlText_.innerHTML = this.localize("Fullscreen")) : (this.player_.requestFullscreen(),
...
vjs.SeekBar.prototype.updateARIAAttributes = function() {
    ...
    this.el_.setAttribute("aria-valuetext", vjs.formatTime(t, this.player_.duration()))
}
,
...
vjs.LoadProgressBar = vjs.Component.extend({
    init: function(t, e) {
        vjs.Component.call(this, t, e),
        this.on(t, "progress", this.update)
    }
}),
...
vjs.LoadProgressBar.prototype.update = function() {
    var t, e, i, n, s = this.player_.buffered(), o = this.player_.duration(), r = this.player_.bufferedEnd(), a = this.el_.children, l = function(t, e) {
        var i = t / e || 0;
        return 100 * i + "%"
    };
    for (this.el_.style.width = l(r, o),
    t = 0; t < s.length; t++)
        e = s.start(t),
        i = s.end(t),
        n = a[t],
        n || (n = this.el_.appendChild(vjs.createEl())),
        n.style.left = l(e, r),
        n.style.width = l(i - e, r);
    for (t = a.length; t > s.length; t--)
        this.el_.removeChild(a[t - 1])
}
,
...
vjs.PlaybackRateMenuButton.prototype.createMenu = function() {
    ...
    if (e)
        for (var i = e.length - 1; i >= 0; i--)
            t.addChild(new vjs.PlaybackRateMenuItem(this.player(),{
                rate: e[i] + "x"
            }));
    return t
}
...
vjs.PosterImage.prototype.setSrc = function(t) {
    var e;
    this.fallbackImg_ ? this.fallbackImg_.src = t : (e = "",
    t && (e = 'url("' + t + '")'),
...
function() {
    ...
    vjs.MediaTechController.prototype.initTextTrackListeners = function() {
        var t = this.player_, e, i = function() {
            var e = t.getChild("textTrackDisplay"), i;
            e && e.updateDisplay()
        };
        e = this.textTracks(),
        e && (e.addEventListener("removetrack", i),
    ...
    vjs.MediaTechController.prototype.emulateTextTracks = function() {
        var t = this.player_, e, i, n;
        window.WebVTT || (n = document.createElement("script"),
        n.src = t.options()["vtt.js"] || "../node_modules/vtt.js/dist/vtt.js",
        t.el().appendChild(n),
        window.WebVTT = !0),
        i = this.textTracks(),
        i && (e = function() {
            var e, i, n;
            for (n = t.getChild("textTrackDisplay"),
            n.updateDisplay(),
            e = 0; e < this.length; e++)
                i = this[e],
                i.removeEventListener("cuechange", vjs.bind(n, n.updateDisplay)),
                "showing" === i.mode && i.addEventListener("cuechange", vjs.bind(n, n.updateDisplay))
        }
        ,
    ...
    vjs.MediaTechController.prototype.textTracks = function() {
        return this.player_.textTracks_ = this.player_.textTracks_ || new vjs.TextTrackList,
        this.player_.textTracks_
    }
    ,
    vjs.MediaTechController.prototype.remoteTextTracks = function() {
        return this.player_.remoteTextTracks_ = this.player_.remoteTextTracks_ || new vjs.TextTrackList,
    ...
    vjs.MediaTechController.withSourceHandlers = function(t) {
        ...
        t.prototype.setSource = function(e) {
            var i = t.selectSourceHandler(e);
            return i || (t.nativeSourceHandler ? i = t.nativeSourceHandler : vjs.log.error("No source hander found for the current source.")),
...
vjs.Html5 = vjs.MediaTechController.extend({
    init: function(t, e, i) {
        var n, s, o, r, a, l;
        (e.nativeCaptions === !1 || e.nativeTextTracks === !1) && (this.featuresNativeTextTracks = !1),
        vjs.MediaTechController.call(this, t, e, i),
        this.setupTriggers();
        var h = e.source;
        if (h && (this.el_.currentSrc !== h.src || t.tag && 3 === t.tag.initNetworkState_) && this.setSource(h),
        this.el_.hasChildNodes()) {
            for (n = this.el_.childNodes,
            s = n.length,
            l = []; s--; )
                r = n[s],
                a = r.nodeName.toLowerCase(),
                "track" === a && (this.featuresNativeTextTracks ? this.remoteTextTracks().addTrack_(r.track) : l.push(r));
...
vjs.Html5.prototype.createEl = function() {
    ...
    for (n = l.length - 1; n >= 0; n--) {
        var h = l[n]
          , c = {};
        "undefined" != typeof t.options_[h] && (c[h] = t.options_[h]),
        vjs.setElementAttributes(s, c)
    }
    return s
}
,
vjs.Html5.prototype.hideCaptions = function() {
    for (var t = this.el_.querySelectorAll("track"), e, i = t.length, n = {
        ...
        e = t[i].track,
        e && e.kind in n && !t[i]["default"] && (e.mode = "disabled")
}
,
vjs.Html5.prototype.setupTriggers = function() {
    for (var t = vjs.Html5.Events.length - 1; t >= 0; t--)
        this.on(vjs.Html5.Events[t], this.eventHandler)
}
,
vjs.Html5.prototype.eventHandler = function(t) {
    "error" == t.type && this.error() ? this.player().error(this.error().code) : (t.bubbles = !1,
...
vjs.Html5.prototype.useNativeControls = function() {
    ...
    s = function() {
        e.off("controlsenabled", i),
        e.off("controlsdisabled", n)
    }
    ,
    t.on("dispose", s),
...
vjs.Html5.prototype.addRemoteTextTrack = function(t) {
    ...
    e.onload = function() {
        var t = e.track;
        e.readyState >= 2 && ("metadata" === t.kind && "hidden" !== t.mode ? t.mode = "hidden" : "metadata" !== t.kind && "disabled" !== t.mode && (t.mode = "disabled"),
        e.onload = null)
    }
    ,
...
vjs.Html5.prototype.removeRemoteTextTrack = function(t) {
    if (!this.featuresNativeTextTracks)
        return vjs.MediaTechController.prototype.removeRemoteTextTrack.call(this, t);
    var e, i;
    for (this.remoteTextTracks().removeTrack_(t),
...
function() {
    ...
    vjs.Html5.prototype.setSource = function(e) {
        var i = t.call(this, e);
        return this.source_ = e.src,
        i
    }
    ,
    vjs.Html5.prototype.disposeSourceHandler = function() {
        return this.source_ = void 0,
        e.call(this)
    }
}(),
...
vjs.Html5.nativeSourceHandler.canHandleSource = function(t) {
    ...
    var i, n;
    return t.type ? e(t.type) : t.src ? (i = t.src.match(/\.([^.\/\?]+)(\?[^\/]+)?$/i),
    n = i && i[1],
    e("video/" + n)) : ""
}
,
...
vjs.Html5.canControlVolume = function() {
    ...
    return vjs.TEST_VID.volume = t / 2 + .1,
    t !== vjs.TEST_VID.volume
}
,
vjs.Html5.canControlPlaybackRate = function() {
    var t = vjs.TEST_VID.playbackRate;
    return vjs.TEST_VID.playbackRate = t / 2 + .1,
    t !== vjs.TEST_VID.playbackRate
}
,
vjs.Html5.supportsNativeTextTracks = function() {
    var t;
    return t = !!vjs.TEST_VID.textTracks,
    t && vjs.TEST_VID.textTracks.length > 0 && (t = "number" != typeof vjs.TEST_VID.textTracks[0].mode),
...
function() {
    var t, e = /^application\/(?:x-|vnd\.apple\.)mpegurl/i, i = /^video\/mp4/i;
    vjs.Html5.patchCanPlayType = function() {
        vjs.ANDROID_VERSION >= 4 && (t || (t = vjs.TEST_VID.constructor.prototype.canPlayType),
        vjs.TEST_VID.constructor.prototype.canPlayType = function(i) {
            return i && e.test(i) ? "maybe" : t.call(this, i)
        }
        ),
        vjs.IS_OLD_ANDROID && (t || (t = vjs.TEST_VID.constructor.prototype.canPlayType),
    ...
    vjs.Html5.unpatchCanPlayType = function() {
        ...
        return vjs.TEST_VID.constructor.prototype.canPlayType = t,
        t = null,
        e
    }
    ,
...
vjs.Flash.nativeSourceHandler.canHandleSource = function(t) {
    var e;
    return t.type ? (e = t.type.replace(/;.*/, "").toLowerCase(),
    e in vjs.Flash.formats ? "maybe" : "") : ""
}
,
...
vjs.Flash.onReady = function(t) {
    var e, i;
    e = vjs.el(t),
    i = e && e.parentNode && e.parentNode.player,
    i && (e.player = i,
    vjs.Flash.checkReady(i.tech))
}
,
...
vjs.Flash.rtmpSourceHandler.handleSource = function(t, e) {
    ...
    e.setRtmpConnection(i.connection),
    e.setRtmpStream(i.stream)
}
,
vjs.Flash.registerSourceHandler(vjs.Flash.rtmpSourceHandler),
vjs.MediaLoader = vjs.Component.extend({
    init: function(t, e, i) {
        if (vjs.Component.call(this, t, e, i),
...
function() {
    vjs.TextTrack = function(e) {
        ...
        vjs.IS_IE8) {
            ...
            for (d in vjs.TextTrack.prototype)
                n[d] = vjs.TextTrack.prototype[d]
        }
        return n.player_ = e.player,
        ...
        Object.defineProperty(n, "mode", {
            ...
            set: function(t) {
                vjs.TextTrackMode[t] && (o = t,
                "showing" === o && this.player_.on("timeupdate", u),
        ...
        Object.defineProperty(n, "activeCues", {
            get: function() {
                ...
                if (0 === this.cues.length)
                    return c;
                for (s = this.player_.currentTime(),
                t = 0,
                e = this.cues.length,
                n = []; e > t; t++)
                    o = this.cues[t],
                    o.startTime <= s && o.endTime >= s ? n.push(o) : o.startTime === o.endTime && o.startTime <= s && o.startTime + .5 >= s && n.push(o);
                if (p = !1,
                n.length !== this.activeCues_.length)
                    p = !0;
                else
                    for (t = 0; t < n.length; t++)
                        -1 === i.call(this.activeCues_, n[t]) && (p = !0);
    ...
    vjs.TextTrack.prototype.addCue = function(t) {
        ...
        if (e)
            for (; i < e.length; i++)
                e[i] !== this && e[i].removeCue(t);
        this.cues_.push(t),
        this.cues.setCues_(this.cues_)
    }
    ,
    vjs.TextTrack.prototype.removeCue = function(t) {
        for (var e = 0, i = this.cues_.length, n, s = !1; i > e; e++)
            n = this.cues_[e],
            n === t && (this.cues_.splice(e, 1),
            s = !0);
    ...
    t = function(t, i) {
        vjs.xhr(t, vjs.bind(this, function(t, n, s) {
            return t ? vjs.log.error(t) : (i.loaded_ = !0,
            void e(s, i))
        }))
    }
    ,
...
vjs.TextTrackList = function(t) {
    ...
    if (vjs.IS_IE8) {
        ...
        for (i in vjs.TextTrackList.prototype)
            e[i] = vjs.TextTrackList.prototype[i]
    }
    for (t = t || [],
    e.tracks_ = [],
...
vjs.TextTrackCueList = function(t) {
    ...
    if (vjs.IS_IE8) {
        ...
        for (i in vjs.TextTrackCueList.prototype)
            e[i] = vjs.TextTrackCueList.prototype[i]
    }
    return vjs.TextTrackCueList.prototype.setCues_.call(e, t),
    Object.defineProperty(e, "length", {
        get: function() {
            return this.length_
        }
...
vjs.TextTrackCueList.prototype.setCues_ = function(t) {
    var e = this.length || 0, i = 0, n = t.length, s;
    if (this.cues_ = t,
...
function() {
    vjs.TextTrackDisplay = vjs.Component.extend({
        init: function(t, e, i) {
            ...
            t.ready(vjs.bind(this, function() {
                if (t.tech && t.tech.featuresNativeTextTracks)
                    return void this.hide();
                var e, i, n;
                for (t.on("fullscreenchange", vjs.bind(this, this.updateDisplay)),
                i = t.options_.tracks || [],
                e = 0; e < i.length; e++)
                    n = i[e],
    ...
    vjs.TextTrackDisplay.prototype.updateDisplay = function() {
        var t = this.player_.textTracks(), e = 0, i;
    ...
    vjs.TextTrackDisplay.prototype.updateForTrack = function(o) {
        if ("function" == typeof window.WebVTT && o.activeCues) {
            for (var r = 0, a, l, h = this.player_.textTrackSettings.getValues(), c, u = []; r < o.activeCues.length; r++)
                u.push(o.activeCues[r]);
            for (window.WebVTT.processCues(window, o.activeCues, this.el_),
            r = u.length; r--; )
                l = u[r].displayState,
                ...
                h.edgeStyle && ("dropshadow" === h.edgeStyle ? l.firstChild.style.textShadow = "2px 2px 3px " + e + ", 2px 2px 4px " + e + ", 2px 2px 5px " + e : "raised" === h.edgeStyle ? l.firstChild.style.textShadow = "1px 1px " + e + ", 2px 2px " + e + ", 3px 3px " + e : "depressed" === h.edgeStyle ? l.firstChild.style.textShadow = "1px 1px " + i + ", 0 1px " + i + ", -1px -1px " + e + ", 0 -1px " + e : "uniform" === h.edgeStyle && (l.firstChild.style.textShadow = "0 0 4px " + e + ", 0 0 4px " + e + ", 0 0 4px " + e + ", 0 0 4px " + e)),
                h.fontPercent && 1 !== h.fontPercent && (c = window.parseFloat(l.style.fontSize),
                l.style.fontSize = c * h.fontPercent + "px",
                l.style.height = "auto",
                l.style.top = "auto",
                l.style.bottom = "2px"),
    ...
    vjs.TextTrackMenuItem = vjs.MenuItem.extend({
        init: function(t, e) {
            var i = this.track = e.track, n = t.textTracks(), s, o;
            n && (s = vjs.bind(this, function() {
                var t = "showing" === this.track.mode, e, i, s;
                if (this instanceof vjs.OffTextTrackMenuItem)
                    for (t = !0,
                    i = 0,
                    s = n.length; s > i; i++)
                        if (e = n[i],
                        e.kind === this.track.kind && "showing" === e.mode) {
                            t = !1;
                            break
                        }
                this.selected(t)
            ...
            vjs.MenuItem.call(this, t, e),
            n && void 0 === n.onchange && this.on(["tap", "click"], function() {
    ...
    vjs.TextTrackMenuItem.prototype.onClick = function() {
        var t = this.track.kind, e = this.player_.textTracks(), i, n, s = 0;
        if (vjs.MenuItem.prototype.onClick.call(this),
        e)
            for (; s < e.length; s++)
                n = e[s],
                n.kind === t && (n === this.track ? n.mode = "showing" : n.mode = "disabled")
    }
    ,
    ...
    vjs.CaptionsButton = vjs.TextTrackButton.extend({
        init: function(t, e, i) {
            vjs.TextTrackButton.call(this, t, e, i),
    ...
    vjs.CaptionsButton.prototype.update = function() {
        ...
        this.player().tech && this.player().tech.featuresNativeTextTracks && (t = 1),
    ...
    vjs.ChaptersButton.prototype.createMenu = function() {
        ...
        var r = this.menu;
        if (void 0 === r && (r = new vjs.Menu(this.player_),
        r.contentEl().appendChild(vjs.createEl("li", {
            className: "vjs-menu-title",
        ...
        s) {
            ...
            i = a.length; i > e; e++)
                l = a[e],
                h = new vjs.ChaptersTrackMenuItem(this.player_,{
                    track: s,
                    cue: l
                }),
                o.push(h),
    ...
    vjs.ChaptersTrackMenuItem = vjs.MenuItem.extend({
        init: function(t, e) {
            var i = this.track = e.track
              ...
              , s = t.currentTime();
            e.label = n.text,
            e.selected = n.startTime <= s && s < n.endTime,
            vjs.MenuItem.call(this, t, e),
            i.addEventListener("cuechange", vjs.bind(this, this.update))
        }
    }),
...
function() {
    ...
    function e(t, e) {
        var i, n;
        if (e) {
            for (i = 0; i < t.options.length && (n = t.options[i],
            n.value !== e); i++)
                ;
            t.selectedIndex = i
        }
    ...
    vjs.JSON.parse = function(text, reviver) {
        function walk(t, e) {
            ...
            if (s && "object" == typeof s)
                for (i in s)
                    Object.prototype.hasOwnProperty.call(s, i) && (n = walk(s, i),
...
vjs.autoSetup = function() {
    var t, e, i, n, s, o = document.getElementsByTagName("video"), r = document.getElementsByTagName("audio"), a = [];
    if (o && o.length > 0)
        for (n = 0,
        s = o.length; s > n; n++)
            a.push(o[n]);
    ...
    if (a && a.length > 0)
        ...
        s = a.length; s > n; n++) {
            ...
            void 0 === e.player && (t = e.getAttribute("data-setup"),
            null !== t && (i = videojs(e)))
        }
    else
...
function(t, e) {
    ...
    function o(t, e, o) {
        var a = this
          ...
          , h = {};
        l ? a = document.createElement("custom") : h.enumerable = !0,
        a.hasBeenReset = !1;
        var c = ""
          , u = !1
          , p = t
...
function(t) {
            ...
            s(t, function(t, e) {
                ...
                case "line":
                    var s = e.split(",")
                      , o = s[0];
                    i.integer(t, o),
                    i.percent(t, o) ? i.set("snapToLines", !1) : null,
                    i.alt(t, o, ["auto"]),
                    2 === s.length && i.alt("lineAlign", s[1], ["start", "middle", "end"]);
                    break;
                case "position":
                    s = e.split(","),
                    i.percent(t, s[0]),
                    2 === s.length && i.alt("positionAlign", s[1], ["start", "middle", "end"]);
                    break;
                case "size":
                    i.percent(t, e);
                    break;
    ...
    function r(t, e) {
        ...
        function o(t) {
            for (; v = t.match(/&(amp|lt|gt|lrm|rlm|nbsp);/); )
                t = t.replace(v[0], s);
            return t
        }
        function r(t, e) {
        ...
        function a(e, i) {
            ...
            s.localName = n;
            var o = y[e];
            return o && i && (s[o] = i.trim()),
            s
        }
        for (var l = t.document.createElement("div"), h = l, c, u = []; null !== (c = n()); )
            if ("<" !== c[0])
                h.appendChild(t.document.createTextNode(o(c)));
            else {
                if ("/" === c[1]) {
                    u.length && u[u.length - 1] === c.substr(2).replace(">", "") && (u.pop(),
                    h = h.parentNode);
                    continue
                }
                var p = i(c.substr(1, c.length - 2)), d;
                if (p) {
                    d = t.document.createProcessingInstruction("timestamp", p),
                    h.appendChild(d);
                    continue
                }
                ...
                if (!r(h, d))
                    continue;
                v[2] && (d.className = v[2].substr(1).replace(".", " ")),
                u.push(v[1]),
                h.appendChild(d),
                h = d
            }
    ...
    function l(t) {
        ...
        if (!t.track || !t.track.textTrackList || !t.track.textTrackList.mediaElement)
            return -1;
        for (var e = t.track, i = e.textTrackList, n = 0, s = 0; s < i.length && i[s] !== e; s++)
            "showing" === i[s].mode && n++;
        return -1 * ++n
    }
    function h() {}
    ...
    function u(t) {
        var e = /MSIE\s8\.0/.test(navigator.userAgent), i, n, s, o;
        if (t.div) {
            ...
            i = r ? Math.max(r[0] && r[0].height || 0, t.height / r.length) : 0
        }
        this.left = t.left,
        this.right = t.right,
        this.top = t.top || o,
    ...
    function p(t, e, i, n) {
        function s(t, e) {
            for (var s, o = new u(t), r = 1, a = 0; a < e.length; a++) {
                for (; t.overlapsOppositeAxis(i, e[a]) || t.within(i) && t.overlapsAny(n); )
                    t.move(e[a]);
                if (t.within(i))
                    return t;
        ...
        n(e)) {
            ...
            !function() {
                for (var i, n, a = 0; a < e.length; a++)
                    ...
                    o.push(u.getSimpleBoxPosition(i))
            }()
        } else
            for (var h = 0; h < e.length; h++)
                s.appendChild(e[h].displayState)
    }
    ,
...
function($, t) {
    var e = {
        ...
        init: function(t) {
            var e, i, n;
            t.originalEvent.origin.match(/vimeo/g) && "data"in t.originalEvent && (n = "string" === $.type(t.originalEvent.data) ? $.parseJSON(t.originalEvent.data) : t.originalEvent.data,
            n && (e = this.setPlayerID(n),
            e.length && (i = this.setVimeoAPIurl(e),
            n.hasOwnProperty("event") && this.handleEvent(n, e, i),
            n.hasOwnProperty("method") && this.handleMethod(n, e, i))))
        },
        ...
        handleEvent: function(t, e, i) {
            ...
            case "ready":
                for (var n in $._data(e[0], "events"))
                    n.match(/loadProgress|playProgress|play|pause|finish|seek|cuechange/) && e[0].contentWindow.postMessage(JSON.stringify({
                        method: "addEventListener",
                        value: n
                    }), i);
                if (e.data("vimeoAPICall")) {
                    for (var s = e.data("vimeoAPICall"), o = 0; o < s.length; o++)
                        e[0].contentWindow.postMessage(JSON.stringify(s[o].message), s[o].api);
                    e.removeData("vimeoAPICall")
                }
                e.data("vimeoReady", !0),
                e.triggerHandler("ready");
                break;
            case "seek":
    ...
    $.vimeo = function(i, n, s) {
        ...
        if ("string" == typeof n && (o.method = n),
        void 0 !== typeof s && "function" != typeof s && (o.value = s),
        "iframe" === i.prop("tagName").toLowerCase() && o.hasOwnProperty("method"))
            if (i.data("vimeoReady"))
                i[0].contentWindow.postMessage(JSON.stringify(o), e.setVimeoAPIurl(i));
            else {
        ...
        return "get" !== n.toString().substr(0, 3) && "paused" !== n.toString() || "function" != typeof s || (!function(i, n, s) {
            var o = t.setInterval(function() {
                e.catchMethods.methodreturn.length != i && (t.clearInterval(o),
                n(e.catchMethods.methodreturn[s]))
            }, 10)
...
function() {
    ...
    var n = i.helpers = {}
      ...
      , x = n.calculateScaleRange = function(t, e, i, n, s) {
        ...
        l === h && (l += .5,
        h >= .5 && !n ? h -= .5 : l += .5);
        for (var c = Math.abs(l - h), u = k(c), p = Math.ceil(l / (1 * Math.pow(10, u))) * Math.pow(10, u), d = n ? 0 : Math.floor(h / (1 * Math.pow(10, u))) * Math.pow(10, u), v = p - d, f = Math.pow(10, u), g = Math.round(v / f); (g > r || r > 2 * g) && !a; )
            if (g > r)
                f *= 2,
                g = Math.round(v / f),
                g % 1 !== 0 && (a = !0);
      ...
      , L = n.animationLoop = function(t, e, i, n, s, o) {
        var r = 0
          ...
          , l = function() {
            ...
            t.call(o, h, i, r),
            n.call(o, h, i),
            e > r ? o.animationFrame = I(l) : s.apply(o)
        };
        I(l)
    }
      , F = n.getRelativePosition = function(t) {
        var e, i, n = t.originalEvent || t, s = t.currentTarget || t.srcElement, o = s.getBoundingClientRect();
        return n.touches ? (e = n.touches[0].clientX - o.left,
        i = n.touches[0].clientY - o.top) : (e = n.clientX - o.left,
        i = n.clientY - o.top),
        {
            x: e,
            y: i
    ...
    r(i.Type.prototype, {
        ...
        render: function(t) {
            ...
            this.options.animation && !t ? n.animationLoop(this.draw, this.options.animationSteps, this.options.animationEasing, this.options.onAnimationProgress, this.options.onAnimationComplete, this) : (this.draw(),
            ...
            if (o || e) {
                ...
                t.length > 0)
                    if (this.datasets && this.datasets.length > 1) {
                        for (var r, a, h = this.datasets.length - 1; h >= 0 && (r = this.datasets[h].points || this.datasets[h].bars || this.datasets[h].segments,
                        a = l(r, t[0]),
                        -1 === a); h--)
                            ;
                        var c = []
                          ...
                          , p = function(t) {
                            ...
                            return n.each(this.datasets, function(t) {
                                ...
                                i[a] && i[a].hasValue() && e.push(i[a])
                            }),
                            n.each(e, function(t) {
                                s.push(t.x),
                                o.push(t.y),
                                c.push(n.template(this.options.multiTooltipTemplate, t)),
                                u.push({
    ...
    i.Tooltip = i.Element.extend({
        draw: function() {
            ...
            t.font = U(this.fontSize, this.fontStyle, this.fontFamily),
            this.xAlign = "center",
            this.yAlign = "above";
    ...
    i.Scale = i.Element.extend({
        ...
        buildYLabels: function() {
            this.yLabels = [];
            for (var t = C(this.stepValue), e = 0; e <= this.steps; e++)
        ...
        fit: function() {
            ...
            var t = this.endPoint - this.startPoint, e;
        ...
        calculateXLabelRotation: function() {
            ...
            var t = this.ctx.measureText(this.xLabels[0]).width, e = this.ctx.measureText(this.xLabels[this.xLabels.length - 1]).width, i, n;
            if (this.xScalePaddingRight = e / 2 + 3,
            this.xScalePaddingLeft = t / 2 > this.yLabelWidth + 10 ? t / 2 : this.yLabelWidth + 10,
            this.xLabelRotation = 0,
            this.display) {
                var s = q(this.ctx, this.font, this.xLabels), o, r;
                this.xLabelWidth = s;
        ...
        calculateX: function(t) {
            ...
            return this.offsetGridLines && (s += n / 2),
            Math.round(s)
        },
        update: function(t) {
            n.extend(this, t),
    ...
    i.RadialScale = i.Element.extend({
        initialize: function() {
            this.size = j([this.height, this.width]),
        ...
        setScaleSize: function() {
            var t = j([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]), e, i, n, s, o = this.width, r, a, l = 0, h, c, u, p, d, v, f;
            for (this.ctx.font = U(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
            i = 0; i < this.valuesCount; i++)
                e = this.getPointPosition(i, t),
                n = this.ctx.measureText(E(this.templateString, {
                    value: this.labels[i]
                })).width + 5,
                0 === i || i === this.valuesCount / 2 ? (s = n / 2,
                e.x + s > o && (o = e.x + s,
                r = i),
                e.x - s < l && (l = e.x - s,
                h = i)) : i < this.valuesCount / 2 ? e.x + n > o && (o = e.x + n,
                r = i) : i > this.valuesCount / 2 && e.x - n < l && (l = e.x - n,
                h = i);
            u = l,
        ...
        draw: function() {
            if (this.display) {
                ...
                if (s(this.yLabels, function(e, i) {
                    if (i > 0) {
                        var n = i * (this.drawingArea / this.steps), s = this.yCenter - n, o;
                        if (this.lineWidth > 0)
                            ...
                            this.lineArc)
                                ...
                                for (var r = 0; r < this.valuesCount; r++)
                                    o = this.getPointPosition(r, this.calculateCenterOffset(this.min + i * this.stepValue)),
                                    0 === r ? t.moveTo(o.x, o.y) : t.lineTo(o.x, o.y);
                                t.closePath(),
                                t.stroke()
                            }
                        if (this.showLabels) {
                            if (t.font = U(this.fontSize, this.fontStyle, this.fontFamily),
                ...
                !this.lineArc) {
                    ...
                    for (var e = this.valuesCount - 1; e >= 0; e--) {
                        ...
                        t.font = U(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
        ...
        getBarsAtEvent: function(t) {
            for (var e = [], n = i.getRelativePosition(t), s = function(t) {
                ...
                for (o = 0; o < this.datasets[r].bars.length; o++)
                    if (this.datasets[r].bars[o].inRange(n.x, n.y))
                        return i.each(this.datasets, s),
                        e;
            return e
        },
    ...
    e.Type.extend({
        ...
        draw: function(t) {
            ...
            i.each(this.datasets, function(t) {
                ...
                this.options.bezierCurve && i.each(a, function(t, e) {
                ...
                n.stroke(),
                this.options.datasetFill && a.length > 0 && (n.lineTo(a[a.length - 1].x, this.scale.endPoint),
                n.lineTo(a[0].x, this.scale.endPoint),
